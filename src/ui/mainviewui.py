...
class Ui_MainView(object):
    def setupUi(self, MainView):
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/ui/menu/flagicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_language.setIcon(icon8)
        self.act_help = QAction(MainView)
        self.act_help.setObjectName(u"act_help")
        icon9 = QIcon()
        icon9.addFile(u":/icons/ui/menu/questionicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_help.setIcon(icon9)
        self.act_about = QAction(MainView)
        self.act_about.setObjectName(u"act_about")
        icon10 = QIcon()
        icon10.addFile(u":/icons/ui/menu/infoicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_about.setIcon(icon10)
        self.act_player_game = QAction(MainView)
        self.act_player_game.setObjectName(u"act_player_game")
        icon11 = QIcon()
        icon11.addFile(u":/icons/ui/menu/gamepadicon", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_player_game.setIcon(icon11)
        ...
        self.mnu_settings_exergames_sub = QMenu(self.mnu_settings)
        self.mnu_settings_exergames_sub.setObjectName(u"mnu_settings_exergames_sub")
        ...
        self.mnu_settings.addAction(self.mnu_settings_exergames_sub.menuAction())
    ...
    def retranslateUi(self, MainView):
        ...
        self.mnu_settings_exergames_sub.setTitle(QCoreApplication.translate("MainView", u"Exergames", None))
